...
A execução do projeto é bem simples, basta:

1. Abrir um terminal na pasta do projeto e executar o comando `make` (está presente no projeto o uso de Makefile);
```sh
make
```

2. Na pasta `bin`, dentro do projeto, executar o arquivo `im_the_executable`;
```sh
./im_the_executable
```
